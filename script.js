...
const wishList = [
  {
    text: "Chúc Mai Anh và gia đình một mùa Trung Thu đoàn viên, tràn ngập niềm vui và hạnh phúc!",
    img: "./assets/1.jpg",
  },
  {
    text: "Cầu chúc cho mọi nguyện ước của Mai Anh đêm nay sẽ trở thành hiện thực.",
    img: "./assets/2.jpg",
  },
  {
    text: "Trăng tròn ấm áp, chúc tình bạn của chúng ta mãi bền chặt.",
    img: "./assets/3.jpg",
  },
  {
    text: "Chúc Mai Anh luôn giữ được tâm hồn trong trẻo, yêu đời như ánh trăng rằm.",
    img: "./assets/1.jpg",
  },
  {
    text: "Trung Thu bình an, vạn sự như ý, học hành thăng tiến rực rỡ!",
    img: "./assets/2.jpg",
  },
  {
    text: "Chúc riêng Mai Anh một đêm trăng thật lãng mạn và ngọt ngào.",
    img: "./assets/3.jpg",
  },
  {
